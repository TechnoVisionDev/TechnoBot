...
public class ExtrasEventListener extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@Nonnull GuildMessageReceivedEvent event) {
        ...
        if (msg.contains("upload")) {
            ...
            if (event.getJDA().getCategoryById(599345363102597132L).getChannels().contains(event.getChannel())) {
                if (!event.getChannel().getId().equals("739159751518322818") /* #programming channel id */) {
